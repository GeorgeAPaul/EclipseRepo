...
public class TestEventLogs {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Process process = Runtime.getRuntime().exec("EventCreate /t INFORMATION /id 123 /l APPLICATION /so Java /d \"LET FLYY!\"");
        //Process process = Runtime.getRuntime().exec("LET FLYY!!");
